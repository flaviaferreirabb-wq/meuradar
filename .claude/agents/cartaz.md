...
**URL nenhuma vai na imagem.** Isso foi testado e descartado: link em imagem não é clicável, a URL encurtada polui o cartão e as linhas extras empurram o rodapé para fora do quadro. O cartaz mostra **o nome do veículo**; o endereço completo e clicável vive no `.txt`, que é postado junto.

**Confira o enquadramento.** Olhe o PNG gerado, não só o tamanho do arquivo. Se o rodapé sair do quadro, tire um item — nunca diminua a fonte.
